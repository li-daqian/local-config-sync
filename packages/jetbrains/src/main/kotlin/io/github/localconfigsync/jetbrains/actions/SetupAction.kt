...
internal fun startSetup(project: Project) {
    ...
    if (choice == 1) {
        ...
        branch = Messages.showInputDialog(project, "Branch", "Create Git Repository", null, "main", null)
            ?.trim().orEmpty().ifBlank { "main" }
    }
...
private fun requiredInput(project: Project, message: String, title: String): String? {
